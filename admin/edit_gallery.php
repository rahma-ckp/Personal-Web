  ...
  <div class="flex max-w-7xl mx-auto mt-8 px-4">
    ...
    <aside class="w-1/4 bg-white rounded shadow p-4">
      ...
      <ul class="space-y-2 text-gray-700">
        ...
        <li><a href="data_artikel.php" class="block hover:text-pink-500">Kelola Artikel</a></li>
        <li><a href="data_gallery.php" class="block font-semibold text-pink-700">Kelola Gallery</a></li>
    ...
    <main class="w-3/4 bg-white rounded shadow p-6 ml-6">
      <form action="proses_edit_gallery.php" method="post" enctype="multipart/form-data" class="space-y-6">
        ...
        <div>
          ...
          <input type="text" id="judul" name="judul" required value="<?php echo htmlspecialchars($data['judul']); ?>" class="w-full p-2 border rounded focus:outline-none focus:ring focus:border-pink-500">
        </div>
        <div>
        ...
        <div>
          ...
          <input type="file" id="foto" name="foto" accept="image/*"
            class="block w-full text-sm text-gray-600 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-pink-100 file:text-pink-700 hover:file:bg-pink-200">
        </div>
        <div class="flex justify-end space-x-4">
          <button type="submit" class="bg-pink-600 text-white px-4 py-2 rounded hover:bg-pink-700 transition">Simpan Perubahan</button>
